...
const AccountsComparisonUI = () => {
  ...
  return (
    <>
      <HeroSection2
        tag="ACCOUNTS"
        title={<>Find your account. Start the right way.</>}
        text={
          "Every FARLO account includes access to all instruments. The differences are in leverage, spreads, and minimum deposit."
        }
        element={
          isMobile ? (
