...
const IntroducingBrokersUI = () => {
  return (
    <>
      <HeroSection2
        tag="Partnerships"
        title={<>Refer traders to FARLO. Earn on every lot they trade.</>}
        text={
          "No minimum client count. No cap on earnings. Commission up to $8 per standard lot, paid monthly."
        }
        bgClassName={styles.bg}
        sectionClassName={styles.hero}
        txtClassName={styles.txt}
        btn1={{ text: "Apply as an Introducing Broker", action: console.log }}
      />
      <EarnMore />
      <BecomePartner />
      <WhySection />
